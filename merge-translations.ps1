...
$gameInstallPath = 'D:\StarCitizen\LIVE' # Set your game installation path here
$gameIniWrite = $true # Set to $true if you want to write directly to the game folder
...
$gameIniPath = Join-Path $gameInstallPath 'data\Localization\french_(france)\global.ini' # now we know the install folder is valid we can stitch on the localization path
if ($gameIniWrite) {
